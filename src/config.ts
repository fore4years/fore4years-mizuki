...
export const siteConfig: SiteConfig = {
	...
	themeColor: {
		hue: 135, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1807117844",
					external: true,
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "蜀ICP备2025177764号 | <img src=\"https://beian.mps.gov.cn/web/assets/logorr01.6189a29f.png\" style=\"width: 16px;height: 16px;margin: 04px;vertical-align:middle;\" alt=\"公安备案图标\"> 川公网安备51011402000992号", // HTML格式的自定义页脚信息，例如备案号等，默认留空
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "客人，你好。承蒙光临，愿您在这里寻得一份舒心。", // 欢迎词
		touch: [
			" 你在干什么啊？",
			"HENTAI!",
			"别这么欺负我啊！",
