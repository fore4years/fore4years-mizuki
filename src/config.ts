	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/fore4years/fore4years-mizuki.git",
					external: true,
...
export const footerConfig: FooterConfig = {
	...
	customHtml: `
		<span style="display: inline-flex; align-items: center; gap: 8px;">
			蜀ICP备2025177764号
			|
			<img src="https://beian.mps.gov.cn/web/assets/logorr01.6189a29f.png" style="width: 16px; height: 16px; vertical-align: middle;" alt="公安备案图标">
