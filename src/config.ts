...
export const footerConfig: FooterConfig = {
	...
	customHtml: "蜀ICP备2025177764号 | <img src=\"/web/assets/logo01.6189a29f.png\" class=\"w-full\" style=\"width: 16px;\" alt=\"公安备案图标\"> 川公网安备51011402000992号", // HTML格式的自定义页脚信息，例如备案号等，默认留空
